...
export default function Hero({ onOpenContact, onOpenGetApp }) {
  return (
    <section className="relative pt-24 bg-white text-slate-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[540px]">
          ...
          {/* ===== LEFT TEXT CONTENT ===== */}
          <div className="lg:col-span-6 pt-10 pb-8 space-y-6 z-10 relative animate-fade-in-left">
            ...
            <div className="space-y-1">
              <h1 className="text-4xl sm:text-5xl font-heading font-black tracking-tight text-slate-900 leading-tight">
                A Delivery Partner
              </h1>
              <h1 className="text-4xl sm:text-5xl font-heading font-black tracking-tight leading-tight">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-3 pt-2">
              <button
                ...
                className="bg-slate-950 hover:bg-slate-900 text-white font-bold px-6 py-3 rounded-xl shadow-md hover:shadow-xl transition-all flex items-center gap-2.5 text-sm group hover:scale-[1.03]"
              >
                <span>Get App</span>
              ...
              <a
                href="#how-it-works"
                className="bg-white text-slate-700 hover:text-slate-900 font-semibold px-6 py-3 rounded-xl border border-slate-300 transition-all flex items-center gap-2 text-sm hover:border-slate-400 shadow-sm hover:scale-[1.02]"
              >
          ...
          <div className="lg:col-span-6 relative pb-6 lg:pb-0 flex justify-center animate-fade-in-right">
            
            {/* Image Container */}
            <div className="relative w-full max-w-[540px] rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-100 group">
              <img 
                src="/hero-rider.jpg" 
              ...
              <div className="absolute top-4 left-4 bg-slate-950/80 backdrop-blur-md text-white text-[11px] font-bold px-3 py-1.5 rounded-full border border-white/20 flex items-center gap-2 shadow-lg">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <span>100% Salaried EV Fleet</span>
              </div>
            </div>

            {/* Floating "Today's Performance" Card */}
            <div className="absolute -bottom-4 sm:bottom-6 right-2 sm:right-0 z-20 w-64 bg-white/95 backdrop-blur-md rounded-2xl p-5 border border-slate-200 shadow-2xl space-y-3 animate-float">
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                <div>
                  ...
                  <span className="text-lg font-heading font-extrabold text-slate-900 block leading-tight">248</span>
                </div>
                <div className="border-x border-slate-100">
                  <span className="text-[10px] text-slate-500 font-medium block">On-Time</span>
                  <span className="text-lg font-heading font-extrabold text-blue-600 block leading-tight">97.6%</span>
                </div>
                <div>
      ...
      <div className="bg-slate-950 mt-8 animate-fade-in-up delay-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-slate-800 py-6">
            
            <div className="flex items-center gap-4 md:pr-8 pb-4 md:pb-0 hover:translate-x-1 transition-transform">
            ...
            <div className="flex items-center gap-4 md:px-8 py-4 md:py-0 hover:translate-x-1 transition-transform">
              <div className="w-12 h-12 rounded-2xl bg-slate-800 border border-slate-700 flex items-center justify-center text-blue-400 shrink-0">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-4 md:pl-8 pt-4 md:pt-0 hover:translate-x-1 transition-transform">
              <div className="w-12 h-12 rounded-2xl bg-slate-800 border border-slate-700 flex items-center justify-center text-blue-400 shrink-0">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
